 ...
 *
 * Validates that the field is required when any of the specified fields are NOT present.
 *
 * Usage:
 *   new RequiredWithout('phone')
 *   new RequiredWithout(['phone', 'fax'])
 *
 ...
 */
final class RequiredWithout implements DataAwareRuleInterface, ImplicitRuleInterface
{
    ...
    /**
     * @param string|array<string> $fields Field(s) that trigger required when absent
     */
    ...
    public function passes(string $attribute, mixed $value): bool
    {
        ...
        if (!$this->anyFieldMissing()) {
            return true;
        }

        // At least one field is missing - this field is required
     ...
     * @return bool
     */
    private function anyFieldMissing(): bool
    {
        if ($this->data === null) {
    ...
    {
        return "The :attribute field is required when " . implode(' / ', $this->fields) . " is not present.";
    }
}
