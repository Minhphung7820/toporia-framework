 ...
 * Class BeforeOrEqual
 *
 * Validates that the date is before or equal to a given date or another field's date.
 *
 ...
 */
final class BeforeOrEqual implements DataAwareRuleInterface
{
    ...
    {
        return "The :attribute must be a date before or equal to {$this->dateOrField}.";
    }
}
