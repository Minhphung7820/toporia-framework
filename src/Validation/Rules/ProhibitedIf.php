 ...
 * Class ProhibitedIf
 *
 * Validates that the field is empty when another field equals a specific value.
 *
 ...
 */
final class ProhibitedIf implements DataAwareRuleInterface, ImplicitRuleInterface
{
    private ?ValidationData $data = null;

    /**
     * @var array<mixed> Values that trigger the prohibition
     */
    private readonly array $values;

    /**
     * @param string $field Field to check
     * @param mixed $values Value(s) that prohibit this field
     */
    ...
    public function message(): string
    {
        ...
        return "The :attribute field is prohibited when {$this->field} is {$valuesStr}.";
    }
}
