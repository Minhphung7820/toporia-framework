 ...
 * Class Gte
 *
 * Validates that the value is greater than or equal to another field's value.
 *
 ...
 */
final class Gte implements DataAwareRuleInterface
{
    ...
    {
        return "The :attribute must be greater than or equal to {$this->field}.";
    }
}
