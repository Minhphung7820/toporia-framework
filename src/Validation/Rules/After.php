 ...
 * Class After
 *
 * Validates that the date is after a given date or another field's date.
 *
 ...
 */
final class After implements DataAwareRuleInterface
{
    ...
    {
        return "The :attribute must be a date after {$this->dateOrField}.";
    }
}
