 ...
 * Class DateEquals
 *
 * Validates that the date is equal to a given date or another field's date.
 *
 ...
 */
final class DateEquals implements DataAwareRuleInterface
{
    ...
    public function passes(string $attribute, mixed $value): bool
    {
        ...
        try {
            ...
            // Compare dates (day-level precision)
            return $valueDate->format('Y-m-d') === $expectedDate->format('Y-m-d');
        } catch (\Exception $e) {
            return false;
        }
    }
    ...
    {
        return "The :attribute must be equal to {$this->dateOrField}.";
    }
}
