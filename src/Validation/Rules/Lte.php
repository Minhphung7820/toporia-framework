 ...
 * Class Lte
 *
 * Validates that the value is less than or equal to another field's value.
 *
 ...
 */
final class Lte implements DataAwareRuleInterface
{
    ...
    {
        return "The :attribute must be less than or equal to {$this->field}.";
    }
}
